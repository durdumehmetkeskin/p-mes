...
var __dsPreview = (() => {
  ...
  function Notes() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid w-80 gap-1.5 p-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Label, { htmlFor: "gr-notes", children: "Goods receipt notes" }),
  ...
  function Disabled() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "grid w-80 gap-1.5 p-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Label, { htmlFor: "closed-note", children: "Closure note (read-only)" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ds_exports.Textarea,
        {
          id: "closed-note",
