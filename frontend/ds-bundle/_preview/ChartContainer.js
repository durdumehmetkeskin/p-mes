...
var __dsPreview = (() => {
  ...
  var require_react_shim = __commonJS({
    "shim:react-shim"(exports, module) {
      ...
      function jsx2(t, p, k2) {
        var c2 = p && p.children;
        return c2 === void 0 ? R.createElement(t, np(p, k2)) : R.createElement(t, np(p, k2), c2);
      }
      function jsxs2(t, p, k2) {
  ...
  var Text = function Text2(_ref5) {
    ...
    return /* @__PURE__ */ import_react11.default.createElement("text", _extends6({}, filterProps(textProps, true), {
      ...
      return (
        ...
        // eslint-disable-next-line react/no-array-index-key
        /* @__PURE__ */ import_react11.default.createElement("tspan", {
          x: x2,
  ...
  function hslConvert(o) {
    ...
    o = o.rgb();
    var r2 = o.r / 255, g2 = o.g / 255, b = o.b / 255, min3 = Math.min(r2, g2, b), max3 = Math.max(r2, g2, b), h = NaN, s2 = max3 - min3, l = (max3 + min3) / 2;
    if (s2) {
      if (r2 === max3) h = (g2 - b) / s2 + (g2 < b) * 6;
      else if (g2 === max3) h = (b - r2) / s2 + 2;
      else h = (r2 - g2) / s2 + 4;
  ...
  _defineProperty9(ErrorBar, "defaultProps", {
    stroke: "black",
    strokeWidth: 1.5,
    width: 5,
    offset: 0,
  ...
  _defineProperty9(ErrorBar, "displayName", "ErrorBar");
  ...
  var getLegendProps = function getLegendProps2(_ref) {
    ...
    var legendProps = legendDefaultProps !== void 0 ? _objectSpread8(_objectSpread8({}, legendDefaultProps), legendItem.props) : {};
    var legendData;
    if (legendItem.props && legendItem.props.payload) {
      ...
      legendData = (formattedGraphicalItems || []).map(function(_ref3) {
        ...
        var itemProps = itemDefaultProps !== void 0 ? _objectSpread8(_objectSpread8({}, itemDefaultProps), item.props) : {};
    ...
    return _objectSpread8(_objectSpread8(_objectSpread8({}, legendProps), Legend.getWithHeight(legendItem, legendWidth)), {}, {
      payload: legendData,
      item: legendItem
    });
  };
  ...
  var getMainColorOfGraphicItem = function getMainColorOfGraphicItem2(item) {
    ...
    var defaultedProps = (_item$type = item.type) !== null && _item$type !== void 0 && _item$type.defaultProps ? _objectSpread9(_objectSpread9({}, item.type.defaultProps), item.props) : item.props;
    ...
    for (var i = 0, len = numericAxisIds.length; i < len; i++) {
      ...
      for (var j = 0, sLen = stackIds.length; j < sLen; j++) {
        ...
        if (barItems && barItems.length) {
          ...
          var barItemProps = barItemDefaultProps !== void 0 ? _objectSpread9(_objectSpread9({}, barItemDefaultProps), barItems[0].props) : barItems[0].props;
  ...
  var appendOffsetOfLegend = function appendOffsetOfLegend2(offset, _unused, props, legendBox) {
    ...
    if (legendProps) {
      ...
      if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) {
        return _objectSpread9(_objectSpread9({}, offset), {}, _defineProperty11({}, align, offset[align] + (boxWidth || 0)));
      }
      if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) {
        return _objectSpread9(_objectSpread9({}, offset), {}, _defineProperty11({}, verticalAlign, offset[verticalAlign] + (boxHeight || 0)));
      }
    }
    return offset;
  };
  ...
  var getStackGroupsByAxisId = function getStackGroupsByAxisId2(data, _items, numericAxisId, cateAxisId, offsetType, reverseStackOrder) {
    ...
    var stackGroups = items.reduce(function(result, item) {
      var _item$type2;
      var defaultedProps = (_item$type2 = item.type) !== null && _item$type2 !== void 0 && _item$type2.defaultProps ? _objectSpread9(_objectSpread9({}, item.type.defaultProps), item.props) : item.props;
      ...
      return _objectSpread9(_objectSpread9({}, result), {}, _defineProperty11({}, axisId, parentGroup));
    ...
    return Object.keys(stackGroups).reduce(function(result, axisId) {
      ...
      if (group.hasStack) {
        ...
        group.stackGroups = Object.keys(group.stackGroups).reduce(function(res, stackId) {
          ...
          return _objectSpread9(_objectSpread9({}, res), {}, _defineProperty11({}, stackId, {
            numericAxisId,
            cateAxisId,
            items: g2.items,
      ...
      return _objectSpread9(_objectSpread9({}, result), {}, _defineProperty11({}, axisId, group));
  ...
  var getStackedDataOfItem = function getStackedDataOfItem2(item, stackGroups) {
    var _item$type3;
    var defaultedProps = (_item$type3 = item.type) !== null && _item$type3 !== void 0 && _item$type3.defaultProps ? _objectSpread9(_objectSpread9({}, item.type.defaultProps), item.props) : item.props;
  ...
  var getTooltipItem = function getTooltipItem2(graphicalItem, payload) {
    var defaultedProps = graphicalItem.type.defaultProps ? _objectSpread9(_objectSpread9({}, graphicalItem.type.defaultProps), graphicalItem.props) : graphicalItem.props;
  ...
  function Label(_ref4) {
    ...
    if (!viewBox || (0, import_isNil7.default)(value) && (0, import_isNil7.default)(children) && !/* @__PURE__ */ (0, import_react14.isValidElement)(content) && !(0, import_isFunction6.default)(content)) {
      return null;
    }
  ...
  function LabelList(_ref) {
    ...
    return /* @__PURE__ */ import_react15.default.createElement(Layer, {
      ...
      return /* @__PURE__ */ import_react15.default.createElement(Label, _extends9({}, filterProps(entry, true), others, idProps, {
        ...
        value,
        textBreakAll,
        viewBox: Label.parseViewBox((0, import_isNil8.default)(clockWise) ? entry : _objectSpread12(_objectSpread12({}, entry), {}, {
          clockWise
        })),
        key: "label-".concat(index),
        index
  ...
  var Curve = function Curve2(props) {
    ...
    return /* @__PURE__ */ React14.createElement("path", _extends11({}, filterProps(props, false), adaptEventHandlers(props), {
  ...
  // node_modules/react-smooth/node_modules/fast-equals/dist/es/index.mjs
  init_define_import_meta_env();
  ...
  var Rectangle = function Rectangle2(rectangleProps) {
    var props = _objectSpread18(_objectSpread18({}, defaultProps2), rectangleProps);
    var pathRef = (0, import_react18.useRef)();
    var _useState = (0, import_react18.useState)(-1), _useState2 = _slicedToArray8(_useState, 2), totalLength = _useState2[0], setTotalLength = _useState2[1];
    ...
    if (!isUpdateAnimationActive) {
      return /* @__PURE__ */ import_react18.default.createElement("path", _extends12({}, filterProps(props, true), {
        className: layerClass,
    ...
    return /* @__PURE__ */ import_react18.default.createElement(es6_default, {
      ...
      }, /* @__PURE__ */ import_react18.default.createElement("path", _extends12({}, filterProps(props, true), {
        className: layerClass,
  ...
  var Cross = function Cross2(_ref) {
    ...
    return /* @__PURE__ */ import_react19.default.createElement("path", _extends14({}, filterProps(props, true), {
  ...
  var Trapezoid = function Trapezoid2(props) {
    ...
    if (!isUpdateAnimationActive) {
      return /* @__PURE__ */ import_react20.default.createElement("g", null, /* @__PURE__ */ import_react20.default.createElement("path", _extends15({}, filterProps(trapezoidProps, true), {
        className: layerClass,
    ...
    return /* @__PURE__ */ import_react20.default.createElement(es6_default, {
      ...
      return /* @__PURE__ */ import_react20.default.createElement(es6_default, {
        ...
        duration: animationDuration,
        easing: animationEasing
      }, /* @__PURE__ */ import_react20.default.createElement("path", _extends15({}, filterProps(trapezoidProps, true), {
        className: layerClass,
  ...
  function ShapeSelector(_ref) {
    ...
    switch (shapeType) {
      case "rectangle":
        return /* @__PURE__ */ import_react21.default.createElement(Rectangle, elementProps);
      case "trapezoid":
        return /* @__PURE__ */ import_react21.default.createElement(Trapezoid, elementProps);
      case "sector":
        return /* @__PURE__ */ import_react21.default.createElement(Sector, elementProps);
      case "symbols":
        if (isSymbolsProps(shapeType, elementProps)) {
          return /* @__PURE__ */ import_react21.default.createElement(Symbols, elementProps);
        }
        break;
      default:
        return null;
  ...
  function getPropsFromShapeOption(option) {
    if (/* @__PURE__ */ (0, import_react21.isValidElement)(option)) {
      return option.props;
    }
    return option;
  }
  function Shape(_ref2) {
    ...
    var shape;
    if (/* @__PURE__ */ (0, import_react21.isValidElement)(option)) {
      shape = /* @__PURE__ */ (0, import_react21.cloneElement)(option, _objectSpread21(_objectSpread21({}, props), getPropsFromShapeOption(option)));
      ...
      shape = /* @__PURE__ */ import_react21.default.createElement(ShapeSelector, {
        shapeType,
  ...
  var generatePrefixStyle = function generatePrefixStyle2(name, value) {
    ...
    var result = PREFIX_LIST.reduce(function(res, entry) {
      return _objectSpread22(_objectSpread22({}, res), {}, _defineProperty24({}, entry + camelName, value));
    }, {});
    result[name] = value;
    return result;
  };
  ...
  var Brush = /* @__PURE__ */ (function(_PureComponent) {
    function Brush2(props) {
      ...
      _defineProperty25(_this, "handleDrag", function(e) {
        if (_this.leaveTimer) {
      ...
      _defineProperty25(_this, "handleTouchMove", function(e) {
        if (e.changedTouches != null && e.changedTouches.length > 0) {
          _this.handleDrag(e.changedTouches[0]);
        }
      });
      _defineProperty25(_this, "handleDragEnd", function() {
        _this.setState({
          isTravellerMoving: false,
          isSlideMoving: false
        }, function() {
      ...
      _defineProperty25(_this, "handleLeaveWrapper", function() {
        if (_this.state.isTravellerMoving || _this.state.isSlideMoving) {
          _this.leaveTimer = window.setTimeout(_this.handleDragEnd, _this.props.leaveTimeOut);
        }
      });
      _defineProperty25(_this, "handleEnterSlideOrTraveller", function() {
        _this.setState({
          isTextActive: true
        });
      });
      _defineProperty25(_this, "handleLeaveSlideOrTraveller", function() {
        _this.setState({
          isTextActive: false
        });
      });
      _defineProperty25(_this, "handleSlideDragStart", function(e) {
    ...
    return _createClass8(Brush2, [{
      ...
      value: function renderTravellerLayer(travellerX, id) {
        ...
        var travellerProps = _objectSpread23(_objectSpread23({}, filterProps(this.props, false)), {}, {
          x: x2,
          y: y2,
      ...
      value: function renderText() {
        ...
        }, /* @__PURE__ */ import_react22.default.createElement(Text, _extends16({
          textAnchor: "end",
          verticalAnchor: "middle",
          x: Math.min(startX, endX) - offset,
          y: y2 + height / 2
        }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ import_react22.default.createElement(Text, _extends16({
          textAnchor: "start",
          verticalAnchor: "middle",
  ...
  function BarRectangle(props) {
    return /* @__PURE__ */ import_react23.default.createElement(Shape, _extends17({
      shapeType: "rectangle",
  ...
  var minPointSizeCallback = function minPointSizeCallback2(minPointSize) {
    ...
    return function(value, index) {
      ...
      !isValueNumberOrNil ? true ? invariant(false, "minPointSize callback function received a value with type of ".concat(_typeof29(value), ". Currently only numbers or null/undefined are supported.")) : invariant(false) : void 0;
      return defaultValue;
    };
  };
  ...
  var Bar = /* @__PURE__ */ (function(_PureComponent) {
    function Bar2() {
      ...
      _defineProperty27(_this, "state", {
        isAnimationFinished: false
      });
      _defineProperty27(_this, "id", uniqueId("recharts-bar-"));
    ...
    return _createClass9(Bar2, [{
      ...
      value: function renderRectanglesStatically(data) {
        ...
        return data && data.map(function(entry, i) {
          ...
          return /* @__PURE__ */ import_react24.default.createElement(Layer, _extends18({
      ...
      value: function renderBackground() {
        ...
        return data.map(function(entry, i) {
          ...
          return /* @__PURE__ */ import_react24.default.createElement(BarRectangle, _extends18({
  ...
  _defineProperty27(Bar, "getComposedData", function(_ref2) {
    ...
    var itemDefaultProps = item.type.defaultProps;
    var itemProps = itemDefaultProps !== void 0 ? _objectSpread25(_objectSpread25({}, itemDefaultProps), item.props) : item.props;
  ...
  var formatAxisMap = function formatAxisMap2(props, axisMap, offset, axisType, chartName) {
    ...
    return ids.reduce(function(result, id) {
      ...
      return _objectSpread26(_objectSpread26({}, result), {}, _defineProperty28({}, id, finalAxis));
    }, {});
  };
  ...
  var createLabeledScales = function createLabeledScales2(options) {
    var scales = Object.keys(options).reduce(function(res, key) {
      return _objectSpread26(_objectSpread26({}, res), {}, _defineProperty28({}, key, ScaleHelper.create(options[key])));
    }, {});
  ...
  var renderLine = function renderLine2(option, props) {
    ...
    if (/* @__PURE__ */ import_react26.default.isValidElement(option)) {
      ...
      line = /* @__PURE__ */ import_react26.default.createElement("line", _extends19({}, props, {
  ...
  function ReferenceLineImpl(props) {
    ...
    var lineProps = _objectSpread27(_objectSpread27({
      clipPath
  ...
  _defineProperty29(ReferenceLine, "displayName", "ReferenceLine");
  _defineProperty29(ReferenceLine, "defaultProps", {
    isFront: false,
    ifOverflow: "discard",
    xAxisId: 0,
    yAxisId: 0,
  ...
  _defineProperty30(ReferenceDot, "displayName", "ReferenceDot");
  _defineProperty30(ReferenceDot, "defaultProps", {
    isFront: false,
    ifOverflow: "discard",
    xAxisId: 0,
    yAxisId: 0,
  ...
  _defineProperty30(ReferenceDot, "renderDot", function(option, props) {
    var dot;
    if (/* @__PURE__ */ import_react27.default.isValidElement(option)) {
      dot = /* @__PURE__ */ import_react27.default.cloneElement(option, props);
    } else if ((0, import_isFunction12.default)(option)) {
      dot = option(props);
    } else {
      dot = /* @__PURE__ */ import_react27.default.createElement(Dot, _extends20({}, props, {
        cx: props.cx,
        cy: props.cy,
  ...
  var ReferenceArea = /* @__PURE__ */ (function(_React$Component) {
    ...
    return _createClass13(ReferenceArea2, [{
      ...
      value: function render() {
        ...
        }, ReferenceArea2.renderRect(shape, _objectSpread29(_objectSpread29({
          clipPath
        }, filterProps(this.props, true)), rect)), Label.renderCallByParent(this.props, rect));
      }
    }]);
  })(import_react28.default.Component);
  _defineProperty31(ReferenceArea, "displayName", "ReferenceArea");
  _defineProperty31(ReferenceArea, "defaultProps", {
    isFront: false,
    ifOverflow: "discard",
    xAxisId: 0,
    yAxisId: 0,
  ...
  _defineProperty31(ReferenceArea, "renderRect", function(option, props) {
    var rect;
    if (/* @__PURE__ */ import_react28.default.isValidElement(option)) {
      ...
      rect = /* @__PURE__ */ import_react28.default.createElement(Rectangle, _extends21({}, props, {
  ...
  var CartesianAxis = /* @__PURE__ */ (function(_Component) {
    ...
    return _createClass14(CartesianAxis2, [{
      ...
      value: function renderAxisLine() {
        ...
        var props = _objectSpread31(_objectSpread31(_objectSpread31({}, filterProps(this.props, false)), filterProps(axisLine, false)), {}, {
          fill: "none"
        });
        ...
        return /* @__PURE__ */ import_react29.default.createElement("line", _extends22({}, props, {
      ...
      value: (
        ...
        function renderTicks(ticks2, fontSize, letterSpacing) {
          ...
          var finalTicks = getTicks(_objectSpread31(_objectSpread31({}, this.props), {}, {
            ticks: ticks2
          ...
          var items = finalTicks.map(function(entry, i) {
            ...
            }, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ import_react29.default.createElement("line", _extends22({}, tickLineProps, lineCoord, {
      ...
      value: function renderTickItem(option, props, value) {
        ...
        if (/* @__PURE__ */ import_react29.default.isValidElement(option)) {
          tickItem = /* @__PURE__ */ import_react29.default.cloneElement(option, _objectSpread31(_objectSpread31({}, props), {}, {
            className: combinedClassName
          }));
        } else if ((0, import_isFunction15.default)(option)) {
          tickItem = option(_objectSpread31(_objectSpread31({}, props), {}, {
            className: combinedClassName
          }));
        } else {
          tickItem = /* @__PURE__ */ import_react29.default.createElement(Text, _extends22({}, props, {
  ...
  function renderLineItem(option, props) {
    ...
    if (/* @__PURE__ */ import_react30.default.isValidElement(option)) {
      ...
      lineItem = /* @__PURE__ */ import_react30.default.createElement("line", _extends23({}, restOfFilteredProps, {
        x1,
        y1,
        x2,
        y2,
  ...
  function HorizontalGridLines(props) {
    ...
    var items = horizontalPoints.map(function(entry, i) {
      var lineItemProps = _objectSpread32(_objectSpread32({}, props), {}, {
        x1: x2,
        y1: entry,
        x2: x2 + width,
        y2: entry,
  ...
  var defaultVerticalCoordinatesGenerator = function defaultVerticalCoordinatesGenerator2(_ref, syncWithTicks) {
    ...
    return getCoordinatesOfGrid(getTicks(_objectSpread32(_objectSpread32(_objectSpread32({}, CartesianAxis.defaultProps), xAxis), {}, {
  ...
  var defaultHorizontalCoordinatesGenerator = function defaultHorizontalCoordinatesGenerator2(_ref2, syncWithTicks) {
    ...
    return getCoordinatesOfGrid(getTicks(_objectSpread32(_objectSpread32(_objectSpread32({}, CartesianAxis.defaultProps), yAxis), {}, {
  ...
  function CartesianGrid(props) {
    ...
    var propsIncludingDefaults = _objectSpread32(_objectSpread32({}, props), {}, {
    ...
    }), /* @__PURE__ */ import_react30.default.createElement(HorizontalGridLines, _extends23({}, propsIncludingDefaults, {
      offset,
      horizontalPoints,
      xAxis,
      yAxis
    })), /* @__PURE__ */ import_react30.default.createElement(VerticalGridLines, _extends23({}, propsIncludingDefaults, {
      offset,
      verticalPoints,
      xAxis,
      yAxis
    })), /* @__PURE__ */ import_react30.default.createElement(HorizontalStripes, _extends23({}, propsIncludingDefaults, {
      horizontalPoints
    })), /* @__PURE__ */ import_react30.default.createElement(VerticalStripes, _extends23({}, propsIncludingDefaults, {
      verticalPoints
    })));
  }
  ...
  function XAxisImpl(_ref) {
    ...
    return (
      ...
      /* @__PURE__ */ React30.createElement(CartesianAxis, _extends24({}, axisOptions, {
  ...
  var XAxis = /* @__PURE__ */ (function(_React$Component) {
    ...
    return _createClass15(XAxis2, [{
      key: "render",
      value: function render() {
        return /* @__PURE__ */ React30.createElement(XAxisImpl, this.props);
      }
    }]);
  })(React30.Component);
  ...
  var YAxisImpl = function YAxisImpl2(_ref) {
    ...
    return (
      // @ts-expect-error the axisOptions type is not exactly what CartesianAxis is expecting.
      /* @__PURE__ */ React31.createElement(CartesianAxis, _extends25({}, axisOptions, {
        className: clsx_default("recharts-".concat(axisOptions.axisType, " ").concat(axisOptions.axisType), axisOptions.className),
        viewBox: {
          x: 0,
          y: 0,
  ...
  var YAxis = /* @__PURE__ */ (function(_React$Component) {
    ...
    return _createClass16(YAxis2, [{
      key: "render",
      value: function render() {
        return /* @__PURE__ */ React31.createElement(YAxisImpl, this.props);
      }
    }]);
  })(React31.Component);
  ...
  function Cursor(props) {
    ...
    return /* @__PURE__ */ (0, import_react31.isValidElement)(elementPropsCursor) ? /* @__PURE__ */ (0, import_react31.cloneElement)(elementPropsCursor, cursorProps) : /* @__PURE__ */ (0, import_react31.createElement)(cursorComp, cursorProps);
  }
  ...
  var generateCategoricalChart = function generateCategoricalChart2(_ref6) {
    ...
    var CategoricalChartWrapper = /* @__PURE__ */ (function(_Component) {
      function CategoricalChartWrapper2(_props) {
        ...
        _defineProperty39(_this, "eventEmitterSymbol", /* @__PURE__ */ Symbol("rechartsEventEmitter"));
        ...
        _defineProperty39(_this, "renderCursor", function(element) {
          ...
          return /* @__PURE__ */ import_react32.default.createElement(Cursor, {
            key,
            activeCoordinate,
            activePayload,
            activeTooltipIndex,
        ...
        _defineProperty39(_this, "renderPolarAxis", function(element, displayName, index) {
          ...
          return /* @__PURE__ */ (0, import_react32.cloneElement)(element, _objectSpread34(_objectSpread34({}, axisOption), {}, {
        ...
        _defineProperty39(_this, "renderLegend", function() {
          ...
          return /* @__PURE__ */ (0, import_react32.cloneElement)(item, _objectSpread34(_objectSpread34({}, otherProps), {}, {
            chartWidth: width,
            chartHeight: height,
            margin,
        ...
        _defineProperty39(_this, "renderGraphicChild", function(element, displayName, index) {
          ...
          var graphicalItem = /* @__PURE__ */ (0, import_react32.cloneElement)(element, _objectSpread34(_objectSpread34({}, item.props), itemEvents));
          ...
          if (hasActive) {
            if (activeTooltipIndex >= 0) {
              ...
              if (activeShape || activeBar) {
                ...
                return [/* @__PURE__ */ (0, import_react32.cloneElement)(element, _objectSpread34(_objectSpread34(_objectSpread34({}, item.props), itemEvents), {}, {
                  activeIndex
                })), null, null];
              }
              ...
              return [/* @__PURE__ */ (0, import_react32.cloneElement)(xyItem, elementProps), null, null];
            }
          }
          if (isRange) {
        ...
        _defineProperty39(_this, "renderCustomized", function(element, displayName, index) {
          return /* @__PURE__ */ (0, import_react32.cloneElement)(element, _objectSpread34(_objectSpread34({
      ...
      return _createClass18(CategoricalChartWrapper2, [{
        ...
        value: function render() {
          ...
          if (compact) {
            return /* @__PURE__ */ import_react32.default.createElement(ChartLayoutContextProvider, {
              state: this.state,
              width: this.props.width,
              height: this.props.height,
              clipPathId: this.clipPathId
            }, /* @__PURE__ */ import_react32.default.createElement(Surface, _extends26({}, attrs, {
              width,
              height,
              title,
              desc
          ...
          return /* @__PURE__ */ import_react32.default.createElement(ChartLayoutContextProvider, {
            ...
            height: this.props.height,
            clipPathId: this.clipPathId
          }, /* @__PURE__ */ import_react32.default.createElement("div", _extends26({
    ...
    var CategoricalChart = /* @__PURE__ */ (0, import_react32.forwardRef)(function CategoricalChart2(props, ref) {
      return /* @__PURE__ */ import_react32.default.createElement(CategoricalChartWrapper, _extends26({}, props, {
        ref
      }));
    });
  ...
  function StockMovements() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-full max-w-xl p-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartContainer, { config: movementConfig, className: "h-[220px] w-full", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, { data: movementData, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartesianGrid, { vertical: false }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XAxis, { dataKey: "month", tickLine: false, axisLine: false, tickMargin: 8 }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartTooltip, { content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartTooltipContent, {}) }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { dataKey: "receipts", fill: "var(--color-receipts)", radius: 4 }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { dataKey: "issues", fill: "var(--color-issues)", radius: 4 })
    ] }) }) });
  }
  var statusConfig = {
  ...
  function OrdersByStatus() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-full max-w-xl p-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartContainer, { config: statusConfig, className: "h-[220px] w-full", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BarChart, { data: statusData, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CartesianGrid, { vertical: false }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(XAxis, { dataKey: "status", tickLine: false, axisLine: false, tickMargin: 8 }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartTooltip, { content: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.ChartTooltipContent, {}) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Bar, { dataKey: "count", fill: "var(--color-count)", radius: 4 })
    ] }) }) });
  }
